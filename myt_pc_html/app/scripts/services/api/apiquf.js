...
/**
 * @ngdoc service
 * @name mytPcHtmlApp.apiQuf
 * @description
 * # apiQuf
 * Factory in the mytPcHtmlApp.
 */
angular.module('mytPcHtmlApp')
  .factory('apiQuf', function (apiUtils,global) {
    // Service logic
    // ...
    ...
    return {
      getByPage: apiUtils.getQuery(function (params) {
        ...
        return {
          method: 'GET',
          url: global.baseUrl + '/api/manage/mytQuestionnaireFill',
          params: params
        }
      }),
      getById: apiUtils.getQuery(function (params) {
        ...
        return {
          method: 'GET',
          url: global.baseUrl + '/api/manage/mytQuestionnaireFill/'+params.id,
          params: params
        }
      }),

...
/**
 * @ngdoc directive
 * @name mytPcHtmlApp.directive:mchLoginLogManagePage
 * @description
 * # mchLoginLogManagePage
 */
angular.module('mytPcHtmlApp')
  .directive('mchLoginLogManagePage', function (apiMain, $filter) {
    return {
            ...
            if (!scope.user) {
              apiMain.user.getById.queryCallback({
                ...
                if (data && data.data) {
                  ...
                  querys.userName = scope.user.userName;

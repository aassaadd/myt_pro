package com.zhc.myt.MytWxRestful.common;
...
public class MytSystem {
	...
	static {
		try {
			PROPS = PropertiesLoaderUtils.loadProperties(new ClassPathResource("/conf/mytSystem.properties"));
		} catch (IOException e) {
			LOGGER.error("系统初始化失败,错误原因:无法读取系统配置文件 /conf/mytSystem.properties", e);

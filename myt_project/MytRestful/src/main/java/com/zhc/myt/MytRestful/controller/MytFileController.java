...
import com.zhc.myt.MytRestful.service.MytFileService;
@RestController
@RequestMapping(value = "/api/manage/mytFile")
public class MytFileController extends BaseController{
	private static Logger LOGGER = LoggerFactory.getLogger(MytFileController.class);
	@Autowired
...
//							+ extMap.get(dirName) + "格式."), request, response);
				...
				// 新的文件名=获取事件挫+。扩展名
				String newFileName = String.valueOf(java.lang.System.currentTimeMillis()) + "." + extensionName;
...
//					returnKindEditorMsg(getError("上传失败."), request, response);
	...
	public Map<String, Object> getById(
		...
		if((postMethod!=null&&!postMethod.equals(""))&&(postMethod.equals("downLoad")||postMethod.equals("image"))){
...
//			@RequestParam(value = "pageSize") Integer pageSize,
		...
		return getReturnMapSuccess(mytFileService.getByPage(pageNumber, pageSize, params));
